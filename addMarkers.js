AFRAME.registerComponent("create-markers", {
    init:async function(){
      ...
      var ratingPlane = document.createElement("a-image");
        ratingPlane.setAttribute("id", `rating-plane-${dish.id}`);
        ratingPlane.setAttribute(
          "geometry",{primitive:"plane",width:2,height:0.3}
        );
        ratingPlane.setAttribute("material",{color:"black"});
        ...
        rating.setAttribute("text", {
          ...
          width: 3,
          align: "center",
          value: `custumer rating:${dish.last_rating}`
        });
        ...
        var reviewPlane = document.createElement("a-image");
        reviewPlane.setAttribute("id", `review-plane-${dish.id}`);
        reviewPlane.setAttribute(
          "geometry",{primitive:"plane",width:2,height:0.5}
        );
        reviewPlane.setAttribute("material",{color:"black"});
        ...
        review.setAttribute("text", {
          ...
          width: 3,
          align: "center",
          value: `custumer review:${dish.last_review}`
        });
